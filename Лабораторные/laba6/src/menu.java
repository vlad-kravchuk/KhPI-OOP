...
public class menu 
{
  public static void main(String[] args) throws IOException, ClassNotFoundException
  {
    ...
    do 
    {
      ...
      System.out.println("11. Сериализация");
      System.out.println("12. Десериализация");
      ...
      System.out.println(arraylist.containsAll(arrlst));
        break;
      case 11:
        list arrlst1 = new list();
        arrlst1.newOne = arraylist;
        FileOutputStream fileOutputStream = new FileOutputStream("Serialized_file");
          ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream);
          
          objectOutputStream.writeObject(arrlst1);
          objectOutputStream.close();
        break;
      case 12:
      {
         FileInputStream fileInputStream = new FileInputStream("Serialized_file");
           ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
           list newArrlst = (list) objectInputStream.readObject();
           objectInputStream.close();
           System.out.println(newArrlst.newOne);
      }
      default: {
